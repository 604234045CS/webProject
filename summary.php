...
// }
    ...
    if (isset($_GET['y_id'])) {
        $year = $_GET['y_id'];
        $sql = "select * from year where y_id ='".$year."'";
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['live','num'],
            <?php
            $sql = "SELECT live,COUNT(infor_id) as num FROM inforhome where y_id ='".$year."' GROUP BY live";
            $fire = mysqli_query($conn,$sql);
                while($result = mysqli_fetch_assoc($fire)){
                    echo "['".$result['live']."',".$result['num']."],";
                }
      ...
      function drawChart1() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['career','num'],
            <?php
             $sql = "SELECT career,COUNT(infor_id) as num FROM inforhome where y_id ='".$year."' GROUP BY career";
             $fire = mysqli_query($conn,$sql);
                while($result = mysqli_fetch_assoc($fire)){
        ...
        function drawChart2() {
            ...
            var data = google.visualization.arrayToDataTable([
                ['relationship','num'],
                <?php
                    $sql = "SELECT relationship,COUNT(infor_id) as num FROM inforhome where y_id ='".$year."' GROUP BY relationship";
                    $fire = mysqli_query($conn,$sql);
                         while($result = mysqli_fetch_assoc($fire)){
        ...
        var data = google.visualization.arrayToDataTable([
            ['income','num'],
            <?php
                $sql = "SELECT income,COUNT(infor_id) as num FROM inforhome where y_id ='".$year."' GROUP BY income";
                $fire = mysqli_query($conn,$sql);
                     while($result = mysqli_fetch_assoc($fire)){
        ...
        function drawChart4() {
            ...
            var data = google.visualization.arrayToDataTable([
                ['money','num'],
            <?php
                 $sql = "SELECT money,COUNT(infor_id) as num FROM inforhome where y_id ='".$year."' GROUP BY money";
                 $fire = mysqli_query($conn,$sql);
                     while($result = mysqli_fetch_assoc($fire)){
        ...
        function drawChart5() {
            ...
            var data = google.visualization.arrayToDataTable([
                ['goschool','num'],
                <?php
                    $sql = "SELECT goschool,COUNT(infor_id) as num FROM inforhome where y_id ='".$year."' GROUP BY goschool";
                    $fire = mysqli_query($conn,$sql);
                        while($result = mysqli_fetch_assoc($fire)){
        ...
        function drawChart6() {
            ...
            var data = google.visualization.arrayToDataTable([
                ['residence','num'],
                <?php
                    $sql = "SELECT residence,COUNT(infor_id) as num FROM inforhome where y_id ='".$year."' GROUP BY residence";
                    $fire = mysqli_query($conn,$sql);
                         while($result = mysqli_fetch_assoc($fire)){
        ...
        function drawChart7() {
            ...
            var data = google.visualization.arrayToDataTable([
                ['substance','num'],
                <?php
                $sql = "SELECT substance,COUNT(infor_id) as num FROM inforhome where y_id ='".$year."' GROUP BY substance";
                $fire = mysqli_query($conn,$sql);
                    while($result = mysqli_fetch_assoc($fire)){
        ...
        function drawChart8() {
            ...
            var data = google.visualization.arrayToDataTable([
                ['informant','num'],
                <?php
                $sql = "SELECT informant,COUNT(infor_id) as num FROM inforhome where y_id ='".$year."' GROUP BY informant";
                $fire = mysqli_query($conn,$sql);
                    while($result = mysqli_fetch_assoc($fire)){
...
?>
    ...
    <ul class="nav nav-tabs">
        <li class="active">
         <a class="nav-link active" data-toggle="tab" href="summary.php?y_id=<?php echo $row['y_id'] ?>"><?php echo $row['y_year']?></a>
     </li>
    </ul>
 <?php
            }
