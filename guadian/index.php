<?php
  ...
  if(isset($_GET['delete'])){
		...
		if(mysqli_num_rows($result) > 0){
			...
			$sql = "delete from guardian where gua_id='".$guaid."'";
    ...
    <ul class="nav">
      ...
      <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">ข้อมูลพื้นฐานผู้ปกครอง</div>
                      <div class="card-body">
                      <table id="example" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                          <?php
                            ...
                            // $sql = "select * from guardian INNER JOIN student ON guardian.gua_id = student.gua_id";
                            $sql = "select * from guardian INNER JOIN student ON guardian.gua_id = student.gua_id 
                            INNER JOIN levels ON student.level_id = levels.level_id INNER JOIN title ON guardian.t_id = title.t_id";
                            $result = mysqli_query($conn, $sql);
                          ...
                          <tr>
                            ...
                            <td><?php echo $row['gua_citizen'] ?></td>
                            <td><?php echo $row['t_name'] ?></td>
                            <td><?php echo $row['gua_name'].' '.$row['gua_lastname'] ?></td>
                            <td><?php echo $row['numphone'] ?></td>
                            <td><?php echo $row['status_stu'] ?></td>
                            <td><?php echo $row['stu_name'] ?></td>
                            <td><?php echo $row['level'] ?></td>
                            <!-- <td class="text-center">
                              <a href="show.php?gua_id=<?php echo $row['gua_id'] ?>" class="btn btn-success"><i class="fa fa-eye"></i></a>
                              <a href="edit.php?gua_id=<?php echo $row['gua_id'] ?>" class="btn btn-info"><i class="fa fa-user-edit"></i></a>
                              <a href="index.php?delete=<?php echo $row['gua_id'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete this record?')"><i class="fa fa-trash-alt"></i></a>
                            </td> -->
                            <td><a href="show.php?gua_id=<?php echo $row['gua_id'] ?>" class="btn btn-success"><i class="fa fa-eye"></i></a></td>
                            <td><a href="edit.php?gua_id=<?php echo $row['gua_id'] ?>" class="btn btn-info"><i class="fa fa-user-edit"></i></a></td>
                            <td><a href="index.php?delete=<?php echo $row['gua_id'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete this record?')"><i class="fa fa-trash-alt"></i></a></td>
                          </tr>
                          <?php
                              }
                            }
