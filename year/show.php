        ...
        <div class="row justify-content-center">
          <div class="card">
            <div class="card-header">
              รายละเอียดข้อมูลปีการศึกษา
            </div>
            <div class="card-body">
              <div class="row">
                <div class="col-md">
                    <h5 class="form-control"><i class="fa fa-id-card">
                      <span><?php echo $row['y_id'] ?></span>
                    </i></h5>
                    <h5 class="form-control"><i class="fa fa-user-tag">
                      <span><?php echo $row['y_name']?></span>
                    </i></h5>
                    <h5 class="form-control"><i class="fa fa-user">
                      <span><?php echo $row['y_year'] ?></span>
                    </i></h5>
                    <h5 class="form-control"><i class="fa fa-user">
                      <span><?php echo $row['y_status'] ?></span>
                    </i></h5>
