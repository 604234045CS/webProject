<?php
  ...
  // if(isset($_GET['delete'])){
	...
	// 		$sql = "delete from year where y_id=".$yid;
                      ...
                      <table id="example" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php echo $row['y_status'] ?></td>
                            <!-- <td class="text-center">
                              <a href="show.php?y_id=<?php echo $row['y_id'] ?>" class="btn btn-success"><i class="fa fa-eye"></i></a>
                              <a href="edit.php?y_id=<?php echo $row['y_id'] ?>" class="btn btn-info"><i class="fa fa-user-edit"></i></a>
                              <!-- <a href="index.php?delete=<?php echo $row['y_id'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete this record?')"><i class="fa fa-trash-alt"></i></a> -->
                            <!-- </td>  -->
                            <td> <a href="show.php?y_id=<?php echo $row['y_id'] ?>" class="btn btn-success"><i class="fa fa-eye"></i></a></td>
                            <td><a href="edit.php?y_id=<?php echo $row['y_id'] ?>" class="btn btn-info"><i class="fa fa-user-edit"></i></a></td>
