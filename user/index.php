<?php
  ...
  if(isset($_GET['delete'])){
		$uid = $_GET['delete'];
		$sql = "select * from user INNER JOIN title ON user.t_id = title.t_id where user_id = '".$uid."'";
                ...
                <div class="card">
                    <div class="card-header">Contact List</div>
                      ...
                      <table id="example" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                          <?php
                            $sql = "select * from user INNER JOIN title ON user.t_id = title.t_id";
                            $result = mysqli_query($conn, $sql);
                          ...
                          <tr>
                            ...
                            <!-- <td class="text-center">
                              <a href="show.php?admin_id=<?php echo $row['user_id'] ?>" class="btn btn-success"><i class="fa fa-eye"></i></a>
                              <a href="edit.php?admin_id=<?php echo $row['user_id'] ?>" class="btn btn-info"><i class="fa fa-user-edit"></i></a>
                              <a href="index.php?delete=<?php echo $row['user_id'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete this record?')"><i class="fa fa-trash-alt"></i></a>
                            </td> -->
                            <td> <a href="show.php?user_id=<?php echo $row['user_id'] ?>" class="btn btn-success"><i class="fa fa-eye"></i></a></td>
                            <td> <a href="edit.php?user_id=<?php echo $row['user_id'] ?>" class="btn btn-info"><i class="fa fa-user-edit"></i></a></td>
                            <td><a href="index.php?delete=<?php echo $row['user_id'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete this record?')"><i class="fa fa-trash-alt"></i></a></td>
                          </tr>
                          <?php
                              }
                            }
