...
?>
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container">
        <a class="navbar-brand" href="../wel_direc.php">แก้ไขข้อมูลส่วนตัว</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
              <li class="nav-item"><a class="btn btn-outline-danger" href="wel_direc.php"><i class="fa fa-sign-out-alt"></i></a></li>
            </ul>
