<?php
  ...
  if (isset($_GET['stu_id'])) {
    $stuid = $_GET['stu_id'];
    $sql = "select * from student INNER JOIN title ON student.t_id = title.t_id where stu_id=".$stuid;
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
              <li class="nav-item"><a class="btn btn-outline-danger" href="index.php?level_id=<?php echo $row['level_id'] ?>"><i class="fa fa-sign-out-alt"></i></a></li>
            </ul>
        </div>
      </div>
    </nav>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <!-- <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="t_id"  placeholder="Enter citizen" value="<?php echo $row['t_name'] ?>" required>
                    </div> -->
                    <div class="form-group">
